...
const About: NextPage = () => {
    ...
    return (
        <>
            ...
            <h1 className="text-2xl md:text-[3.5rem] leading-normal text-center font-extrabold text-gray-900">
                About Me
            </h1>
            <main className="container flex mx-auto h-fit pl-4 justify-center">
                ...
                <article className="text-center p-4 float-right w-1/3">
                    ...
                    <p>Though I have far left to go, I am proud of my progress thus far, so please take a look at <Link href="https://www.icloud.com/iclouddrive/01eLKZZdNlzIHTcMJ8NmpYsGw#CEOkoroji%5FResume" download="CEOkoroji Resume" className="underline" target="_blank">my resume here</Link> and <Link href="https://www.linkedin.com/in/chukwuma-okoroji-a3a6931bb/" className="underline" target="_blank">my LinkedIn here</Link>.</p>
                </article>
            </main>
        </>
    )
