...
const Projects: NextPage = () => {
	const portfolioProjects: Project[] = [
		...
		},
		{
			...
			deployment:
				'https://rusty-melody-client-blackstack-software-solutions.koyeb.app/',
		...
		},
		{
			name: 'Magic 8 Ball',
			description:
				'A simple Magic 8 Ball app. The user asks a question and the app generates a random answer. At the time it was a huge step in my learning journey with JavaScript and the DOM.',
	...
	return (
		<div className='relative flex flex-col h-full'>
			...
			<span className='text-lg w-full text-center leading-normal font-medium mt-4'>
				Specializations
			</span>
			...
			{/* Cricle vectors */}
			<div className='fixed left-0 -translate-x-14 2xl:translate-x-[25.5rem] bottom-24 w-24 h-24 bg-transparent rounded-full border-2 border-accent/80' />
			<div className='fixed right-0 translate-x-14 2xl:translate-x-12 top-24 2xl:top-52 w-24 h-24 bg-transparent rounded-full border-2 border-accent/80' />
		</div>
	);
};
