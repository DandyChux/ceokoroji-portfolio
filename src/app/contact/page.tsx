...
export default function ContactPage() {
	return (
		<div className='flex flex-col items-center w-full h-full py-8 px-4 md:px-32 mx-auto self-start'>
			<div
			...
			/>
			<h1 className='text-3xl mb-2 text-center md:m-0 md:text-[3rem] leading-normal font-semibold'>
				Contact Me
			</h1>
