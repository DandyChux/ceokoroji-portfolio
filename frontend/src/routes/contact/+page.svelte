...
<div class="flex flex-col items-center justify-center min-h-screen p-12">
	<div class="w-full max-w-2xl">
		<h1 class="text-4xl lg:text-6xl mb-8 font-semibold text-center">Get In Touch</h1>
		...
		<form onsubmit={handleSubmit} class="flex flex-col gap-4">
			...
			{#if submitStatus}
				<div class="p-4 rounded-lg {submitStatus === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}">
					{statusMessage}
				</div>
			{/if}
